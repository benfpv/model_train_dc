...
String masterDirName = "RAIL_MIDSPLIT";
String allRailSectionsDirs[5][10] = 
{
{"MAIN"}, 
{"MAIN", "MIDS"}, {"MAIN", "MIDS", "JNRT"}, {"MAIN", "MSTP"}, {"MAIN", "MSTP", "JNRT"}
};
String allRailSectionsNames[] = 
{
"MAIN", "MIDS", "JNRT", "MSTP", "JNRT"
};
String allSubordinateNames[5][3] = 
{
{"MIDS", "MSTP", "NONE"}, 
{"JNRT", "NONE", "NONE"}, {"NONE", "NONE", "NONE"}, {"JNRT", "NONE", "NONE"}, {"NONE", "NONE", "NONE"}
};
...
{
{"NONE", "NONE", "NONE"}, 
{"MAIN", "NONE", "NONE"}, {"MIDS", "MSTP", "NONE"}, {"MAIN", "NONE", "NONE"}, {"MIDS", "MSTP", "NONE"}
};
...
int beginProxPins_IN[] = {22, 24, 26, 28, 26}; // Digital In
int endProxPins_IN[] = {23, 25, 27, 29, 27}; // Digital In
...
int stationProxPins_IN[] = {40, 41, 42};

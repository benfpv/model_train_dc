# Rail_Parser.py  —  RAIL_SIMPLE config
# Pre-configured to parse the RAIL_SIMPLE layout.
#
# USAGE (option A — copy to project root):
#   Copy this file to the project root, then run from there:
#       cd path/to/model_train_dc
#       python Rail_Parser.py
#
# USAGE (option B — via tools/):
#   Update master_folder_name in tools/Rail_Parser.py to "RAIL_SIMPLE",
...
master_folder_name = "RAIL_SIMPLE" # Folder Name that contains folder tree of rail section names.
...
class Main():
    ...
    def clear_ino():
        ...
        for line in lines:
            ...
            line_count += 1
        print(" ***** ")
        print("Line Begin: {}".format(lines[line_ino_begin]))
        print("Line End: {}".format(lines[line_ino_end]))
        print(" ***** ")
